...
def abrir_acerca_de():
   messagebox.showinfo("Acerca de", "Punto de Venta de Ropa/nProyecto Escolarn/Versión 1.0")
...
# -------------------------
ventana = tk.Tk()
ventana.title("Punto de Venta - Software punto de venta fernandarodriguez2010")
...
try:
   ...
   imagen = Image.open(os.path.join(BASE_DIR,"logo.png")) # Cambia por el archivo del alumno
